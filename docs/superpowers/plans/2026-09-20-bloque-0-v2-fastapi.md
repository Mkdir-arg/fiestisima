...
**Files:** `api/app/mail.py`, `api/app/routers/{invitations,users,businesses}.py`, `api/migrations/0006_business_users_view.sql`, `api/tests/{test_invitations,test_users,test_rls_matrix}.py`.
